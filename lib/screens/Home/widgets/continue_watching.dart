      ...
      children: <Widget>[
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              seriesItem("harry potter", "Harry Potter", "Philosopher's Stone"),
              seriesItem("star wars", "Star Wars", "A New Hope"),
              seriesItem("back to future", "Back to Future", "The Musical"),
            ],
          ),
        )
      ],
...
Widget seriesItem(String imageName, String seriesName, episodeName) {
  return Container(
